...
const taxonomyPath = path.resolve('src/data/taxonomies/ecommerce.ts');
let content = fs.readFileSync(taxonomyPath, 'utf8');

// Update imports
content = content.replace(
  'MonitorSmartphone\n, Presentation } from \'lucide-react\';',
  'MonitorSmartphone\n, Presentation, Compass, ShieldCheck, Receipt, Ticket, Eye, Mail } from \'lucide-react\';'
);

// Define the new taxonomy array content
const newTaxonomy = `export const ecommerceProductionTaxonomy: Category[] = [
  {
    ...
    topics: [
      ...
      createTopic('Product Validation', Search, [], 'ecommerceproductvalidation'),
      ...
      createTopic('Supplier Strategy', Truck, [], 'ecommercesupplierstrategy'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Product Discovery', Compass, [], 'ecommerceproductdiscovery'),
      ...
      createTopic('Trust Signals', ShieldCheck, [], 'ecommercetrustsignals'),
  ...
  },
  {
    ...
    topics: [
      createTopic('Platform Strategy', Globe, [], 'ecommerceplatformstrategy'),
      createTopic('Tech Stack', Layers, [{name:'Next.js Commerce',url:'https://vercel.com/commerce'}], 'ecommercetechstackselection'),
      createTopic('Build vs Buy', HelpCircle, [{name:'MedusaJS',url:'https://medusajs.com/'}], 'ecommercebuildvsbuyshopify'),
      ...
      createTopic('Inventory', Database, [{name:'Available to Promise',url:'https://www.inventory-planner.com/'}], 'ecommerceinventoryarchitecture'),
      ...
      createTopic('Cart', ShoppingCart, [{name:'Redis Cart State',url:'https://upstash.com/blog/redis-cart'}], 'ecommercecartarchitecture'),
      createTopic('Checkout', CreditCard, [{name:'Stripe Tax',url:'https://stripe.com/tax'}], 'ecommercecheckoutarchitecture'),
      createTopic('Payments', DollarSign, [{name:'Auth & Capture',url:'https://stripe.com/docs/payments/auth-and-capture'}], 'ecommercepaymentarchitecture'),
      createTopic('Shipping', Truck, [{name:'Shippo API',url:'https://goshippo.com/'}], 'ecommerceshippingarchitecture'),
      createTopic('Taxes', Receipt, [], 'ecommercetaxes'),
      createTopic('Search', Search, [{name:'Algolia E-commerce',url:'https://www.algolia.com/solutions/ecommerce/'}], 'ecommercesearcharchitecture'),
      createTopic('Discount & Coupon System', Ticket, [], 'ecommercediscountsystem'),
      createTopic('Order Lifecycle', RefreshCcw, [], 'ecommerceorderlifecycle'),
      createTopic('Analytics', BarChart, [{name:'Facebook CAPI',url:'https://developers.facebook.com/docs/marketing-api/conversions-api/'}], 'ecommerceanalyticsarchitecture'),
    ]
  },
  {
    ...
    topics: [
      ...
      createTopic('Customer Experience Features', Heart, [], 'ecommercecustomerexperiencefeatures'),
      createTopic('Reviews & Ratings', Star, [], 'ecommercereviewsratings'),
      createTopic('Returns & Refunds Logic', RefreshCcw, [], 'ecommercereturnslogic'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Observability', Eye, [{name:'Axiom',url:'https://axiom.co/'}], 'ecommerceobservability'),
      createTopic('Payment & Fraud Protection', ShieldAlert, [{name:'Stripe Radar',url:'https://stripe.com/radar'}], 'ecommercepaymentprotection'),
      ...
      createTopic('Inventory Consistency', ListChecks, [], 'ecommerceinventoryconsistency'),
      createTopic('Webhook Reliability', Zap, [], 'ecommercewebhookreliability'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('E-commerce SEO', Search, [{name:'JSON-LD Product Schema',url:'https://developers.google.com/search/docs/appearance/structured-data/product'}], 'ecommerceseosetup'),
      ...
      createTopic('Email Setup', Mail, [], 'ecommerceemailsetup'),
...
content = content.replace(/export const ecommerceProductionTaxonomy: Category\[\] = \[[\s\S]*?\];\n\nconst filterTaxonomy/, newTaxonomy + '\n\nconst filterTaxonomy');

// Update filters to reflect renamed topics
content = content.replace(
  /'Inventory Architecture', 'Inventory', 'Fraud Prevention', 'SEO Setup', 'Shipping Architecture',/g,
  /'Inventory', 'Payment & Fraud Protection', 'E-commerce SEO', 'Shipping',/g
);
content = content.replace(
  /'Fraud Prevention', 'Scalability Planning'/g,
  /'Payment & Fraud Protection', 'Scalability Planning'/g
);

// We need to ensure we don't duplicate names in the hide list, 'Inventory' might appear twice now if I just rename 'Inventory Architecture'
content = content.replace(/'Inventory', 'Inventory', /g, "'Inventory', ");
content = content.replace(/'Shipping', \n    'Shipping Setup', 'Monitoring'/g, "'Shipping', \n    'Shipping Setup', 'Observability'");
content = content.replace(/'Advanced Monitoring'/g, "'Observability'");


fs.writeFileSync(taxonomyPath, content);
console.log("Updated ecommerce.ts successfully");
