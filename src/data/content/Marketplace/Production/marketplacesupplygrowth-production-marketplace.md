...
Back in Phase 0, you picked a chicken-and-egg strategy to get initial supply and demand off the ground. This module assumes that worked â€” you have some real sellers and some real buyers â€” and asks a more mature question: how do you grow supply deliberately now, with actual data, instead of through the bootstrapping hacks that got you started?
...
Undifferentiated supply growth â€” just "more sellers" â€” can make a liquidity problem worse if the new sellers list in categories that already have too much supply relative to demand, while the category buyers actually want stays thin.
...
> **âš ï¸ Warning:** Growing total seller count without checking category-level demand can make your marketplace look more active while actually making it worse â€” buyers see more unsold, stale listings cluttering search results, which erodes trust in exactly the categories you most need to look credible.
...
> **âœ… Best Practice:** For a personal project, manually recruiting a handful of strong sellers in your most underserved, highest-demand category usually beats a broad incentive program. A handful of good sellers who buyers can actually find and trust does more for liquidity than a larger number of low-quality or mismatched listings.

## The Highest-Leverage Move: Reduce Friction for Sellers Already Inside

People who already trust you enough to create one listing are your cheapest source of more supply â€” easier to convert than a stranger you have to recruit from scratch.
...
> **ðŸ’¡ Tip:** This connects directly back to the Retention module â€” if you diagnosed seller relisting friction as a leak there, fixing it serves both retention and supply growth simultaneously. Don't treat them as separate projects if the root cause and the fix are the same.

## Seller Quality vs Seller Quantity

> **âš ï¸ Warning:** A surge of low-quality, low-trust new sellers can actively hurt your marketplace â€” buyers who have one bad experience with a low-quality seller may not give the platform a second chance, even if most sellers are good. Growing supply without any quality bar trades short-term listing-count growth for long-term buyer trust, which is a bad trade for a marketplace specifically, where trust is the product.
...
- Watch early review/rating signals on new sellers closely â€” this is your earliest warning of a quality problem before it affects broader trust

## Use AI to Find Your Specific Supply Gap

**Prompt â€” Category-Level Supply Gap Analysis**
```
...
3. Given I'm a solo builder, what's the most realistic way to recruit 
   sellers specifically into that gap â€” manual outreach, incentive, 
   or friction reduction for existing sellers?
```

> **ðŸ’¡ Token Efficiency:** Provide category-level data, even rough estimates, rather than asking generically about supply growth â€” undifferentiated supply advice ("partner with influencers," "run ads") is far less useful than a targeted answer about your specific demand/supply mismatch.
...
With supply growth targeted at your actual gap, the next module turns to Demand Growth â€” making sure the buyer side keeps pace, since new supply only creates value if there's demand ready to meet it.
