...
Supply and demand growth get people to your marketplace. Reviews are what convince a stranger to actually complete a transaction with another stranger — they're the trust mechanism that substitutes for the in-person judgment buyers would normally rely on. A marketplace with real activity but thin, low-quality reviews still feels risky to a new buyer, no matter how much supply or demand you've built.

## The Decision You're Actually Making

Not "how do we get more reviews." It's: **at the exact moment a hesitant buyer is deciding whether to trust a seller they've never met, does what we show them actually resolve that hesitation — or is it noise?**
...
|---|---|
| "5 stars, great!" | Almost nothing — could be fake, could be low-effort, resolves no real doubt |
| "5 stars — shipped next day, exactly as described, would buy from again" | Specific, credible, answers the actual questions a buyer has |
...
> ** Best Practice:** Prompt reviewers with a specific question, not a blank box — "How was the item's condition compared to the description?" produces far more useful reviews than an open "leave a review" field, which tends to generate low-effort, generic responses.
...
- Never require a review to complete a transaction — this produces resentful, low-quality, or fake positive reviews just to get past a gate

> **️ Warning:** Making a review mandatory to close out a transaction seems like an easy way to guarantee volume, but it backfires — buyers rushing through a forced step leave low-effort or reflexively positive reviews, which is worse for trust than having fewer, but genuine, reviews.

## Decision: How to Handle Negative Reviews

| Approach | Trust impact |
|---|---|
| Let all reviews post unmoderated (except clear policy violations) | Higher trust — buyers know reviews are unfiltered and real |
| Allow sellers to respond publicly to a negative review | Higher trust — shows accountability without hiding the original feedback |
...
> **️ Warning:** Removing negative reviews to keep sellers happy is a short-term fix with a long-term cost. A marketplace where reviews clearly aren't filtered is more trustworthy than one that appears polished — buyers are good at detecting when a review section looks too perfect to be real, and that suspicion undermines the entire trust system.
...
> ** Tip:** A buyer deciding between two similar listings often makes the call based on which seller has more visible, credible trust signals — put the review summary where comparison actually happens (search results), not only on a page they may never click into.

## Addressing the Cold-Start Review Problem

New sellers have no reviews yet, which is a real disadvantage that compounds — no reviews makes buyers hesitant, which means fewer sales, which means no reviews.
...
> ** Tip:** Verified badges (identity, payment method) are a reasonable substitute trust signal for brand-new sellers who haven't had the chance to accumulate reviews yet — they answer a different but related question ("is this a real, accountable person") while reviews build up naturally.

## Use AI to Audit Your Review System's Actual Trust Signal

**Prompt — Review System Trust Audit**
```
...
> ** Token Efficiency:** Describe your actual current flow rather than asking generically "how do I improve reviews" — a description of what exists lets AI identify specific gaps instead of listing generic review-system best practices you may already know.
...
| Timely review requests right after completion | Delayed or absent review requests | — |

## What's Next

With trust signals strengthened, the final growth module is Liquidity Optimization — pulling supply, demand, and trust together into the core measure of whether your marketplace is actually functioning as a marketplace, not just a collection of features.
