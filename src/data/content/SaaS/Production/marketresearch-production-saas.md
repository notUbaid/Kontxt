 ...
 **AI has a training cutoff.** It will not know about products launched recently, recent funding rounds, or live pricing pages. Use AI output as a starting map, then verify every specific claim against live sources.
```
