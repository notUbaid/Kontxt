...
Your value proposition is the answer to one question every potential customer asks the moment they land on your store:
...
Before defining yours, clear out the noise.
...
## The Four Sources of Differentiation

Real value propositions come from one of four places. Identify which one yours comes from before you try to write it.

### 1. Product Differentiation
You sell something genuinely different — in quality, design, materials, function, or provenance.
...
The way you sell — curation, education, packaging, post-purchase experience — is better than alternatives.
...
Once you know your source of differentiation, construct the statement:

> **For** [specific customer]
> **who** [has this specific problem or desire],
> **[Store Name]** is the [category]
> **that** [delivers this specific outcome]
> **unlike** [alternative], **which** [fails in this way].
...
## The Landing Page Headline Test

Your value proposition should be expressible as a homepage headline in under 10 words.

These headlines are value propositions in disguise:

- *"Desk tools for developers who think in systems."*
...
[paste your one-sentence customer portrait from the Target Audience module]
...
- [ ] Value proposition written using the formula above
- [ ] Source of differentiation identified (product / specificity / experience / price-value)
