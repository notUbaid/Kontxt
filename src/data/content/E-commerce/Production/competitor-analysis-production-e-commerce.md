...
Competitor analysis is not about copying what others do. It's about understanding the landscape well enough to know where you fit — and where you don't.

Solo store builders who skip this step usually discover their "unique" idea already exists at scale, or that they're pricing against a competitor they didn't know existed, or that their entire value proposition is already commoditised.

Spend 30 minutes here. It's cheaper than discovering these things after launch.
...
These are the most important to understand. If your target customer isn't buying from you, they're probably buying from one of these.
...
These define the edges of your market. Understand them, but don't over-index on them.

### Tier 3: Substitute Alternatives
The DIY option, the marketplace (Amazon, Etsy), the "just do without it" option.

These are often the most powerful competitors — not because they're better, but because they require the least effort from the customer.

---

## What to Analyse

For each Tier 1 competitor, document these seven dimensions:

| Dimension | What to look for |
|---|---|
| **Product range** | How many products? How deep? What's missing? |
| **Price points** | What's the low, mid, and high end? |
...
> **The weakness column is gold.** Go read 1-star and 2-star reviews of your direct competitors on marketplaces. Customers will tell you exactly what the market isn't delivering. That's your opening.
...
Draw this simply — even a rough sketch works. The goal is to see where white space exists. That white space is where your store lives.
...
> If your store plots in the same quadrant as a well-funded, established competitor, that's a warning sign — not a dealbreaker, but a reason to sharpen your differentiation.
...
> "Every existing store in this category treats [X] as an afterthought. We'll make it central."

**3. The exploitable weakness:**
> "Customers consistently complain that existing options [specific complaint]. We'll solve that directly."

These statements become the backbone of your positioning — and directly inform how you write your homepage copy.
...
```
I'm building a personal e-commerce store in the following category:
...
5. Suggest the two most useful positioning axes for a map of this market

I'll do my own primary research after this — I just want a starting framework to work from.
```
...
A gap that requires you to be cheaper than everyone else to fill it is not sustainable. A gap that requires you to know something, curate something, or serve someone better — that's sustainable.
...
- [ ] Your store's position on the map doesn't overlap with a dominant competitor
...
>
> Before you build anything, you'll define what success actually looks like for this store — in numbers you can measure, not feelings you can't.
