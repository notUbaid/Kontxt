...
export const ecommerceProductionTaxonomy: Category[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Account Implementation', Users, [{name:'NextAuth',url:'https://next-auth.js.org/'}], 'ecommerceaccountimplementation'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Growth Analytics', BarChart, [{name:'Mixpanel E-commerce',url:'https://mixpanel.com/'}], 'ecommercegrowthanalytics'),
