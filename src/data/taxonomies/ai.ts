...
export const aiProductionTaxonomy: Category[] = [
  {
    ...
    topics: [
      createTopic('Use Cases', CheckSquare, [], 'aiusecases'),
      ...
      createTopic('AI Justification', Lightbulb, [], 'aiaijustification'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Tool Calling', Link, [], 'aitoolcalling'),
      createTopic('MCP', Link, [], 'aimcp'),
      createTopic('Agents', Bot, [], 'aiagents'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Vector Database', Database, [], 'aivectordatabase'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Rate Limiting', Activity, [], 'airatelimiting'),
