...
export const extensionProductionTaxonomy: Category[] = [
  {
    ...
    topics: [
      createTopic('Idea Definition', Rocket, [{name:'Chrome Extensions Docs',url:'https://developer.chrome.com/docs/extensions'}], 'extideadefinition'),
      ...
      createTopic('Feature Planning', CheckSquare, [{name:'Linear',url:'https://linear.app/'},{name:'Notion Templates',url:'https://www.notion.so/templates'}], 'extfeatureplanning'),
  ...
  },
  {
    ...
    topics: [
      createTopic('PRD', FileText, [{name:'System Design Primer',url:'https://github.com/donnemartin/system-design-primer'},{name:'Excalidraw',url:'https://excalidraw.com/'}], 'extprd'),
      ...
      createTopic('Wireframes', Box, [{name:'Figma',url:'https://www.figma.com/'},{name:'Shadcn UI',url:'https://ui.shadcn.com/'},{name:'Tailwind CSS',url:'https://tailwindcss.com/'},{name:'Radix UI Accessibility',url:'https://www.radix-ui.com/'}], 'extwireframes'),
      createTopic('Design System', PenTool, [{name:'Figma',url:'https://www.figma.com/'},{name:'Shadcn UI',url:'https://ui.shadcn.com/'},{name:'Tailwind CSS',url:'https://tailwindcss.com/'},{name:'Radix UI Accessibility',url:'https://www.radix-ui.com/'}], 'extdesignsystem'),
      ...
      createTopic('Extension UX', Layout, [{name:'Figma',url:'https://www.figma.com/'},{name:'Shadcn UI',url:'https://ui.shadcn.com/'},{name:'Tailwind CSS',url:'https://tailwindcss.com/'},{name:'Radix UI Accessibility',url:'https://www.radix-ui.com/'}], 'extextensionux'),
    ]
  },
  {
    ...
    topics: [
      createTopic('API Design', Link, [{name:'tRPC',url:'https://trpc.io/'},{name:'GraphQL',url:'https://graphql.org/'},{name:'Postman',url:'https://www.postman.com/'}], 'extapidesign'),
      createTopic('Authentication', Lock, [{name:'Clerk Auth',url:'https://clerk.com/'},{name:'Supabase Auth',url:'https://supabase.com/auth'},{name:'OWASP Top 10',url:'https://owasp.org/www-project-top-ten/'}], 'extauthentication'),
      ...
      createTopic('Extension Fundamentals', BookOpen, [{name:'Chrome Ext MV3',url:'https://developer.chrome.com/docs/extensions/mv3/intro/'},{name:'MDN WebExtensions',url:'https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions'}], 'extextensionfundamentals'),
      createTopic('Platform Selection', Globe, [{name:'Supabase',url:'https://supabase.com/'},{name:'Prisma ORM',url:'https://www.prisma.io/'},{name:'Drizzle ORM',url:'https://orm.drizzle.team/'},{name:'SQLite',url:'https://www.sqlite.org/'}], 'extplatformselection'),
      createTopic('Architecture Design', Server, [{name:'System Design Primer',url:'https://github.com/donnemartin/system-design-primer'},{name:'Excalidraw',url:'https://excalidraw.com/'}], 'extarchitecturedesign'),
      ...
      createTopic('Content Scripts', Code, [{name:'Content Scripts Overview',url:'https://developer.chrome.com/docs/extensions/develop/concepts/content-scripts'}], 'extcontentscripts'),
      ...
      createTopic('Service Workers', Activity, [{name:'tRPC',url:'https://trpc.io/'},{name:'GraphQL',url:'https://graphql.org/'},{name:'Postman',url:'https://www.postman.com/'}], 'extserviceworkers'),
      createTopic('Storage Strategy', Database, [{name:'Supabase',url:'https://supabase.com/'},{name:'Prisma ORM',url:'https://www.prisma.io/'},{name:'Drizzle ORM',url:'https://orm.drizzle.team/'},{name:'SQLite',url:'https://www.sqlite.org/'}], 'extstoragestrategy'),
      createTopic('Messaging System', MessageCircle, [{name:'Chrome Ext MV3',url:'https://developer.chrome.com/docs/extensions/mv3/intro/'},{name:'MDN WebExtensions',url:'https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions'}], 'extmessagingsystem'),
  ...
  },
  {
    ...
    topics: [
      createTopic('Auth', Lock, [{name:'Clerk Auth',url:'https://clerk.com/'},{name:'Supabase Auth',url:'https://supabase.com/auth'},{name:'OWASP Top 10',url:'https://owasp.org/www-project-top-ten/'}], 'extauth'),
      ...
      createTopic('Messaging System', MessageCircle, [{name:'Chrome Ext MV3',url:'https://developer.chrome.com/docs/extensions/mv3/intro/'},{name:'MDN WebExtensions',url:'https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions'}], 'extmessagingsystem'),
      createTopic('Storage', Database, [{name:'Supabase',url:'https://supabase.com/'},{name:'Prisma ORM',url:'https://www.prisma.io/'},{name:'Drizzle ORM',url:'https://orm.drizzle.team/'},{name:'SQLite',url:'https://www.sqlite.org/'}], 'extstorage'),
  ...
  },
  {
    ...
    topics: [
      createTopic('Security', Shield, [{name:'Clerk Auth',url:'https://clerk.com/'},{name:'Supabase Auth',url:'https://supabase.com/auth'},{name:'OWASP Top 10',url:'https://owasp.org/www-project-top-ten/'}], 'extsecurity'),
      createTopic('Performance Optimization', Zap, [{name:'Supabase',url:'https://supabase.com/'},{name:'Prisma ORM',url:'https://www.prisma.io/'},{name:'Drizzle ORM',url:'https://orm.drizzle.team/'},{name:'SQLite',url:'https://www.sqlite.org/'}], 'extperformanceoptimization'),
      ...
      createTopic('CI/CD', Rocket, [{name:'Vercel',url:'https://vercel.com/'},{name:'GitHub Actions',url:'https://github.com/features/actions'},{name:'Product Hunt Launch',url:'https://www.producthunt.com/'}], 'extcicd'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Firefox Add-ons', Globe, [{name:'Chrome Ext MV3',url:'https://developer.chrome.com/docs/extensions/mv3/intro/'},{name:'MDN WebExtensions',url:'https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions'}], 'extfirefoxaddons'),
