...
export const desktopProductionTaxonomy: Category[] = [
  {
    ...
    topics: [
      ...
      createTopic('Problem Statement', AlertCircle, [{name:'Mom Test Guide',url:'https://www.momtestbook.com/'},{name:'YC RFS',url:'https://www.ycombinator.com/rfs'}], 'dtproblemstatement'),
      createTopic('Target Users', UserCheck, [{name:'Whimsical',url:'https://whimsical.com/'},{name:'FigJam',url:'https://www.figma.com/figjam/'},{name:'Mobbin UX Patterns',url:'https://mobbin.com/'}], 'dttargetusers'),
  ...
  },
  {
    ...
    topics: [
      createTopic('PRD', FileText, [{name:'System Design Primer',url:'https://github.com/donnemartin/system-design-primer'},{name:'Excalidraw',url:'https://excalidraw.com/'}], 'dtprd'),
      ...
      createTopic('Design System', PenTool, [{name:'Figma',url:'https://www.figma.com/'},{name:'Shadcn UI',url:'https://ui.shadcn.com/'},{name:'Tailwind CSS',url:'https://tailwindcss.com/'},{name:'Radix UI Accessibility',url:'https://www.radix-ui.com/'}], 'dtdesignsystem'),
      ...
      createTopic('Desktop UX', Layout, [{name:'Figma',url:'https://www.figma.com/'},{name:'Shadcn UI',url:'https://ui.shadcn.com/'},{name:'Tailwind CSS',url:'https://tailwindcss.com/'},{name:'Radix UI Accessibility',url:'https://www.radix-ui.com/'}], 'dtdesktopux'),
    ]
  },
  {
    ...
    topics: [
      ...
      createTopic('Business Logic', Settings, [{name:'Sentry',url:'https://sentry.io/'},{name:'Datadog',url:'https://www.datadoghq.com/'}], 'dtbusinesslogic'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Documentation', BookOpen, [{name:'Tauri Guide',url:'https://tauri.app/v1/guides/'},{name:'Electron Docs',url:'https://www.electronjs.org/docs/latest'}], 'dtdocumentation'),
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Auto Updates', RefreshCw, [{name:'Tauri Guide',url:'https://tauri.app/v1/guides/'},{name:'Electron Docs',url:'https://www.electronjs.org/docs/latest'}], 'dtautoupdates'),
      createTopic('Packaging', Box, [{name:'Tauri Guide',url:'https://tauri.app/v1/guides/'},{name:'Electron Docs',url:'https://www.electronjs.org/docs/latest'}], 'dtpackaging'),
    ]
  },
  {
