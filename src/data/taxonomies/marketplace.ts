...
export const marketplaceProductionTaxonomy: Category[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Marketplace Fundamentals', BookOpen, [{name:'Sharetribe Guide',url:'https://www.sharetribe.com/academy/'}], 'marketplacefundamentals'),
  ...
  },
  {
    ...
    topics: [
      createTopic('Authentication', Lock, [{name:'Clerk Dual-sided Auth',url:'https://clerk.com/'}], 'marketplaceauthenticationimplementation'),
      ...
      createTopic('Authorization', Shield, [{name:'Supabase RLS',url:'https://supabase.com/docs/guides/auth/row-level-security'}], 'marketplaceauthorizationimplementation'),
