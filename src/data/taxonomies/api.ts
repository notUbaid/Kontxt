...
export const apiProductionTaxonomy: Category[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      createTopic('Rate Limiting Implementation', Activity, [{name:'Upstash Ratelimit',url:'https://upstash.com/docs/redis/features/ratelimit'}], 'apiratelimitingimplementation'),
